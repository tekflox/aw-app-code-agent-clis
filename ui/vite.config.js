// Component-mode plugin bundle only (this app has no standalone page) — Vite
// lib mode building src/plugin.jsx -> dist/code-agent-clis.js, the bundle
// aw-app.json's contributes.frontend.bundle points at.
//
